...
- the whole slice with product-level acceptance, not a method — implementer lanes delegate per the two-tools rule above (sub-lanes: Sol for well-specified code, kimi for UI) and own their lifecycle;
